...
def _applyCosmetics(title, xlabel, ylabel, xlimits, ylimits, legendLocation, figureDims=None):
	fontsize = 20
...
def plotAverageTimeSeries(samplesDict, ylabel, outFile, title=None,
	...
	xscale='lin', yscale='lin', margins=0.1, timeRange=None, figureDims=None):
	...
	_applyCosmetics(title, xlabel, ylabel, [0, xlimit] if xlimit else None, [0, ylimit] if ylimit else limits, legendLocation, figureDims=figureDims)
...
def plotAllTimeSeries(samplesDict, ylabel, outFile, title=None, xlabel='Time',
	...
	xscale='lin', yscale='lin', margins=0.1, timeRange=None, figureDims=None, strips='conf95'):
...
def plotComputationVariableAgainstParameter(experiment, variableName, variableGenerator, parameterName,
                                    ...
                                    xlimit=None, ylimit=None, xlabel=None, ylabel=None, figureDims=None):
  ...
  '''
	...
	for tCondPoint in tCondPoints:
		...
		plotAverageTimeSeries(data, ylabel, pointStr + '.png',
		                      ...
		                      xscale=xscale, yscale=yscale, figureDims=figureDims, strips=strips)
